...
\begin{itemize}[leftmargin=2em]
  ...
  \item 当前证明的是显式策略的可执行性、动作合法性和若干局部环境性质，
...
\begin{itemize}[leftmargin=2em]
  ...
  Lean 证明说明抽象后的环境语义、witness 计划以及 \texttt{task\_5}
  高层阶段机策略在逻辑上自洽。
\end{itemize}
